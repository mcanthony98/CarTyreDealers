...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
  ...
  <div class="container d-flex flex-column flex-md-row justify-content-between">
    ...
    <a class="py-2 d-none d-md-inline-block" href="#">Tryes</a>
    <a class="py-2 d-none d-md-inline-block" href="#">Vehicles</a>
    <a class="py-2 d-none d-md-inline-block" href="#">Sellers</a>
    <a class="py-2 d-none d-md-inline-block" href="#">Dealers</a>
    <a class="py-2 d-none d-md-inline-block" href="#"></a>
    <a class="py-2 d-none d-md-inline-block" href="#"></a>
    <a class="py-2 d-none d-md-inline-block" href="login.php">Login</a>
    <a class="py-2 d-none d-md-inline-block" href="signup.php">Sign up</a>
  </div>
</nav>
...
<hr class="featurette-divider">
  <div class="row featurette" style="padding-top:0px">
          <div class="col-md-6" style="padding-left:50px">
            ...
            <div><button class="btn btn-lg btn-primary" href="user/tyres.php">See what we have now</button>
			</p>
        ...
        <div class="row featurette">
          <div class="col-md-6 order-md-2" style="padding-right:50px">
           ...
           <div><button class="btn btn-lg btn-primary" href="user/vehicle.php">Search your vehicle</button>
			</p>
        ...
        <div class="row featurette">
          <div class="col-md-6" style="padding-left:50px">
           ...
           <div><button class="btn btn-lg btn-primary" href="user/prices.php">Compare prices</button>
			</p>
