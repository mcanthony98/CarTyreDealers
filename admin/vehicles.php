...
<a style="padding-left=10px" class="btn btn-sm btn-primary" href="vehicle_add.php" name="search">+ Add New</a>
        ...
        <table class="table table-striped table-sm">
		  ...
		  ?>
            <tr>
              ...
              <td><a class="btn btn-sm btn-success" href="vehicle_edit.php?vehicle_id=<?php echo $row["vehicle_id"];?>">Edit</a>
			  <a class="btn btn-sm btn-danger" href="../processes/vehicle_delete.php?vehicle_id=<?php echo $row["vehicle_id"];?>" role="button" onClick="return confirm('Do you really want to delete?');">Delete</a></td>
            </tr>
			<?php
			$counter++;
		  }
