...
<main role="main">	
		...
		<tr>
		   <td>Password: </td>
		   <td Style="text-transform:capitalize"><?php print "******************" ?></td>
		...
		<tr>
		   <th  style="text-align:right;" width="10%"></th>
		   <th  style="text-align:left;" width="40%"><h4>Contact Details:</h4></th>
		   
		</tr>
		<tr>
		   <td>Email: </td>
		   <td Style="text-transform:capitalize"><?php print $row["email"]; ?></td>
		   
		</tr>
		<tr>
		   <td>Phone: </td>
		   <td Style="text-transform:capitalize"><?php print $row["phone"]; ?></td>
		...
		<div  align="center" style="padding-top:10px;margin-top:400px; padding-bottom:10px; background-color:rgba(0,0,0,.05)">
			<a class=" btn-success btn-lg" href="company_edit.php">Edit Info</a>
