...
<form style="padding-top:50px" class="form-signin" action="../processes/tyre_add.php" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
	  ...
	  <br />
      <input type="text"  class="form-control" name="type" placeholder="Tyre Type" required >
	  <br/>
	  <input type="number"  class="form-control" name="rim" placeholder="Rim Size in Inches" required >
	  <br/>
	  <input type="number"  class="form-control" name="width" placeholder="Tyre width in mm" required >
	  <br/>
	  <input type="number"  class="form-control" name="profile" placeholder="Tyre Profile" required >
	  <br/>
	  <input type="number"  class="form-control" name="load_index" placeholder="Load Index" required >
	  <br/>
	  <input type="text"  class="form-control" name="speed_symbol" placeholder="Speed symbol" required >
	  <br/>
	  <select class="form-control" name="purpose" required>
		<option >Suggest Where it's used...</option>
		<?php
      ...
      <button class="btn btn-lg btn-primary btn-block" type="submit" name = "tyre_add" >Add New</button>
	  <br/>
    </form>
</div>
